...
This is the parent component. It defines a property called `symbol` on line 20 and assigns it a random value on lines 23-24. We pass the property to the child component on line 12. Notice the syntax: `[icon]='symbol'`. The child prop is identified by square brackets, and the parent prop is in quotes. If you want to pass a string literal, you must use two sets of quotes (see the next section).
